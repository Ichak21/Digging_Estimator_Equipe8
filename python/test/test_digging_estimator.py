...
def test_1shift_1dwarve_should_9_total_dwarves():
    ...
    assert nb_dwarves_needed.total == 9
...
def test_we_must_have_1_innkeepers_by_4_dwaves_in_miners_smithies_healers_lighters():
    ...
    assert nb_dwarves_needed.day_team.inn_keepers + nb_dwarves_needed.night_team.inn_keepers == 20
...
def test_we_must_have_1_guards_by_3_dwaves_exclude_innkeeper():
    ...
    assert nb_dwarves_needed.day_team.guards + nb_dwarves_needed.night_team.guards == 5
...
def test_we_must_have_1_guardsManager_by_3_guards():
    ...
    assert nb_dwarves_needed.day_team.guard_managers + nb_dwarves_needed.night_team.guard_managers == 2
...
def test_we_must_have_1_washer_by_10_dwarves():
    ...
    assert nb_dwarves_needed.day_team.washers + nb_dwarves_needed.night_team.washers == 5
